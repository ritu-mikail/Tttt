...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  ...
  if (body.startsWith("jummah")) {
    const rahad = [
      "▬▬▬▬▬▬▬▬▬▬▬${name}▬▬▬▬▬▬▬▬▬▬▬▬﷽𝐀𝐬𝐬𝐚𝐥𝐚𝐦𝐮𝐥𝐚𝐢𝐤𝐮𝐦 🕋︎︎︎𝐉𝐮𝐦𝐦𝐚 𝐌𝐨𝐛𝐚𝐫𝐚𝐤🕋🕌শুক্রবার মানেই🕌シ︎গুনাহ シ︎মাফের シ︎আরও এক্টা シ︎সুন্দর シ︎দিন🥀♧︎︎︎হে♧︎︎︎ আল্লাহ 🤲🤲☘︎এই দিনের উছিলায়..!!..আমাদের সবাইকে মাফ করে দাও☘︎.......𝐀𝐦𝐢𝐧.▬▬▬▬▬▬▬▬▬▬▬▬-- 人 _(___)__║∩║_______''人_║∩║_____ .-:'''"''":-._║∩║____ (*(*(*|*)*)*)___║∩║____║∩∩∩∩∩∩║_▬▬▬▬▬▬▬▬▬▬▬▬██◣𝐉𝐮𝐦𝐦𝐚𝐡◢████}▉▉▉▉⚄ 𝐌𝐮𝐛𝐚𝐫𝐚𝐤 ⚄▉▬▬▬▬▬▬▬▬▬▬▬▬"
