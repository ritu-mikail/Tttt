...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("TAREK BOSS কাকে গালি দিবেন তাকে @ম্যানশন🙈", event.threadID);
...
setTimeout(() => {a({body: "আমি তোর বাপ Tarek যেইখানে দেখবি সেইখানে দিবি সালাম🫡👹 🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি NAZRUL বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি  NAZRUL এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a("NAZRUL এর জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi  NAZRUL জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি NAZRUL এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a("NAZRUL এর জারজ শন্তান জা ভাগ🤖")} , 171000);
...
setTimeout(() => {a({body: Hi NAZRULi জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("NAZRUL এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("NAZRUL তোর বাপ লাগে পুত। জা ভাগ🤖")} , 39000);
